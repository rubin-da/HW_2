...
public:
    ...
    KDL::JntArray getInvKin(const KDL::JntArray &q, const KDL::Frame &eeFrame);
    ...
    void getInverseKinematics(KDL::Frame &f,KDL::Twist &twist,KDL::Twist &acc,KDL::JntArray &q,KDL::JntArray &dq,KDL::JntArray &ddq);
